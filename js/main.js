...
function init() {
    ...
    scene.background = new THREE.Color(0xcccccc); // 设置背景颜色
    ...
    // 光源 (均匀环境光)
    const ambientLight = new THREE.AmbientLight(0xffffff, 1.5); // 增强环境光亮度以模拟均匀光照
    ...
    controls.screenSpacePanning = false; // 禁止在屏幕空间平移
